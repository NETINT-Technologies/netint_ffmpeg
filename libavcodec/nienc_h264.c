...
ff_h264_ni_quadra_encoder = {
...
#else
    .p.long_name      = NULL_IF_CONFIG_SMALL("H.264 NETINT Quadra encoder v" NI_XCODER_REVISION),
#endif
    ...
    .long_name        = NULL_IF_CONFIG_SMALL("H.264 NETINT Quadra encoder v" NI_XCODER_REVISION),
